from accretion.secrets import SENDGRID_API_KEY
from sendgrid import SendGridAPIClient
from sendgrid.helpers.mail import Mail    
    


def send_mail(subject, html_content,user_email):
    message = Mail(
    from_email= ('hello@accretion.so', 'Accretion'),
...
def test_mail(user_email):
                ...
                <tr>
                    ...
                    <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                        ...
                        <td style="padding:0 0 36px 0;color:#153643;">
                            <h1 style="font-size:24px;margin:0 0 20px 0;font-family:Arial,sans-serif;">Welcome to your weekly wrap!</h1>
                        </td>
                        </tr>
                        <tr>
                        <td style="padding:0;">
    ...
    """
    send_mail(subject, html_content, user_email)